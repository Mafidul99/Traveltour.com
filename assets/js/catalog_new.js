...
! function(t) { t.fn.fluid_dg = function(i, a) {
        function e() { return !!(navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i)) || void 0 }

        function o() { var i = t(T).width();
            t("li", T).removeClass("fluid_dg_visThumb"), t("li", T).each(function() { var a = t(this).position(),
                    e = t("ul", T).outerWidth(),
                    o = t("ul", T).offset().left,
                    d = t("> div", T).offset().left - o;
                d > 0 ? t(".fluid_dg_prevThumbs", X).removeClass("hideNav") : t(".fluid_dg_prevThumbs", X).addClass("hideNav"), e - d > i ? t(".fluid_dg_nextThumbs", X).removeClass("hideNav") : t(".fluid_dg_nextThumbs", X).addClass("hideNav"); var r = a.left,
                    s = a.left + t(this).width();
                i >= s - d && r - d >= 0 && t(this).addClass("fluid_dg_visThumb") }) }

        function d() {
            function a() { if (K = h.width(), -1 != i.height.indexOf("%")) { var a = Math.round(K / (100 / parseFloat(i.height)));
                    J = "" != i.minHeight && a < parseFloat(i.minHeight) ? parseFloat(i.minHeight) : a, h.css({ height: J }) } else "auto" == i.height ? J = h.height() : (J = parseFloat(i.height), h.css({ height: J }));
                t(".fluid_dgrelative", _).css({ width: K, height: J }), t(".imgLoaded", _).each(function() { var a, e, o = t(this),
                        d = o.attr("width"),
                        r = o.attr("height"),
                        s = (o.index(), o.attr("data-alignment")),
                        n = o.attr("data-portrait"); if ((void 0 === s || !1 === s || "" === s) && (s = i.alignment), (void 0 === n || !1 === n || "" === n) && (n = i.portrait), 0 == n || "false" == n)
                        if (K / J > d / r) { var l = K / d,
                                c = .5 * Math.abs(J - r * l); switch (s) {
                                case "topLeft":
                                case "topCenter":
                                case "topRight":
                                    a = 0; break;
                                ...
                                case "bottomRight":
                                    a = "-" + 2 * c + "px" }
                            o.css({ height: r * l, "margin-left": 0, "margin-right": 0, "margin-top": a, position: "absolute", visibility: "visible", width: K }) } else { l = J / r, c = .5 * Math.abs(K - d * l); switch (s) {
                                case "topLeft":
                                    e = 0; break;
                                case "topCenter":
                                    e = "-" + c + "px"; break;
                                ...
                                case "bottomRight":
                                    e = "-" + 2 * c + "px" }
                            o.css({ height: J, "margin-left": e, "margin-right": e, "margin-top": 0, position: "absolute", visibility: "visible", width: d * l }) }
                    else if (K / J > d / r) { l = J / r, c = .5 * Math.abs(K - d * l); switch (s) {
                            case "topLeft":
                                e = 0; break;
                            case "topCenter":
                                e = c + "px"; break;
                            ...
                            case "bottomRight":
                                e = 2 * c + "px" }
                        o.css({ height: J, "margin-left": e, "margin-right": e, "margin-top": 0, position: "absolute", visibility: "visible", width: d * l }) } else { l = K / d, c = .5 * Math.abs(J - r * l); switch (s) {
                            case "topLeft":
                            case "topCenter":
                            case "topRight":
                                a = 0; break;
                            ...
                            case "bottomRight":
                                a = 2 * c + "px" }
                        o.css({ height: r * l, "margin-left": 0, "margin-right": 0, "margin-top": a, position: "absolute", visibility: "visible", width: K }) } }) } var e;
            1 == A ? (clearTimeout(e), e = setTimeout(a, 200)) : a(), A = !0 }

        function r() { t("iframe", u).each(function() { t(".fluid_dg_caption", u).show(); var a = t(this),
                    e = a.attr("data-src");
                a.attr("src", e); var o = i.imagePath + "blank.gif",
                    d = new Image; if (d.src = o, -1 != i.height.indexOf("%")) { var r = Math.round(K / (100 / parseFloat(i.height)));
                    J = "" != i.minHeight && r < parseFloat(i.minHeight) ? parseFloat(i.minHeight) : r } else J = "auto" == i.height ? h.height() : parseFloat(i.height);
                a.after(t(d).attr({ class: "imgFake", width: K, height: J })); var s = a.clone();
                a.remove(), t(d).bind("click", function() { "absolute" == t(this).css("position") ? (t(this).remove(), -1 != e.indexOf("vimeo") || -1 != e.indexOf("youtube") ? -1 != e.indexOf("?") ? autoplay = "&autoplay=1" : autoplay = "?autoplay=1" : -1 != e.indexOf("dailymotion") && (-1 != e.indexOf("?") ? autoplay = "&autoPlay=1" : autoplay = "?autoPlay=1"), s.attr("src", e + autoplay), Q = !0) : (t(this).css({ position: "absolute", top: 0, left: 0, zIndex: 10 }).after(s), s.css({ position: "absolute", top: 0, left: 0, zIndex: 9 })) }) }) }

        function s(t) { for (var i, a, e = t.length; e; i = parseInt(Math.random() * e), a = t[--e], t[e] = t[i], t[i] = a); return t }

        function n() { if (t(T).length && !t(k).length) { var i, a = t(T).outerWidth(),
                    e = (t("ul > li", T).outerWidth(), t("li.fluid_dgcurrent", T).length ? t("li.fluid_dgcurrent", T).position() : ""),
                    d = t("ul > li", T).length * t("ul > li", T).outerWidth(),
                    r = t("ul", T).offset().left,
                    s = t("> div", T).offset().left;
                i = 0 > r ? "-" + (s - r) : s - r, 1 == et && (t("ul", T).width(t("ul > li", T).length * t("ul > li", T).outerWidth()), t(T).length && !t(k).lenght && h.css({ marginBottom: t(T).outerHeight() }), o(), t("ul", T).width(t("ul > li", T).length * t("ul > li", T).outerWidth()), t(T).length && !t(k).lenght && h.css({ marginBottom: t(T).outerHeight() })), et = !1; var n = t("li.fluid_dgcurrent", T).length ? e.left : "",
                    l = t("li.fluid_dgcurrent", T).length ? e.left + t("li.fluid_dgcurrent", T).outerWidth() : "";
                n < t("li.fluid_dgcurrent", T).outerWidth() && (n = 0), l - i > a ? d > n + a ? t("ul", T).animate({ "margin-left": "-" + n + "px" }, 500, o) : t("ul", T).animate({ "margin-left": "-" + (t("ul", T).outerWidth() - a) + "px" }, 500, o) : 0 > n - i ? t("ul", T).animate({ "margin-left": "-" + n + "px" }, 500, o) : (t("ul", T).css({ "margin-left": "auto", "margin-right": "auto" }), setTimeout(o, 100)) } }

        function l() { $ = 0; var a = t(".fluid_dg_bar_cont", X).width(),
                e = t(".fluid_dg_bar_cont", X).height(); if ("pie" != f) switch (V) {
                case "leftToRight":
                    t("#" + p).css({ right: a }); break;
                case "rightToLeft":
                    t("#" + p).css({ left: a }); break;
                case "topToBottom":
                    t("#" + p).css({ bottom: e }); break;
                case "bottomToTop":
                    t("#" + p).css({ top: e }) } else it.clearRect(0, 0, i.pieDiameter, i.pieDiameter) }

        function c(a) { m.addClass("fluid_dgsliding"), Q = !1; var o = parseFloat(t("div.fluid_dgSlide.fluid_dgcurrent", _).index()); if (a > 0) var g = a - 1;
            else if (o == q - 1) g = 0;
            else g = o + 1; var v = t(".fluid_dgSlide:eq(" + g + ")", _),
                b = t(".fluid_dgSlide:eq(" + (g + 1) + ")", _).addClass("fluid_dgnext"); if (o != g + 1 && b.hide(), t(".fluid_dgContent", u).fadeOut(600), t(".fluid_dg_caption", u).show(), t(".fluid_dgrelative", v).append(t("> div ", m).eq(g).find("> div.fluid_dg_effected")), t(".fluid_dg_target_content .fluid_dgContent:eq(" + g + ")", h).append(t("> div ", m).eq(g).find("> div")), t(".imgLoaded", v).length) { if (L.length > g + 1 && !t(".imgLoaded", b).length) { var y = L[g + 1],
                        C = new Image;
                    C.src = y, b.prepend(t(C).attr("class", "imgLoaded").css("visibility", "hidden")), C.onload = function() { _t = C.naturalWidth, vt = C.naturalHeight, t(C).attr("data-alignment", B[g + 1]).attr("data-portrait", S[g + 1]), t(C).attr("width", _t), t(C).attr("height", vt), d() } }
                i.onLoaded.call(this), t(".fluid_dg_loader", h).is(":visible") ? t(".fluid_dg_loader", h).fadeOut(400) : (t(".fluid_dg_loader", h).css({ visibility: "hidden" }), t(".fluid_dg_loader", h).fadeOut(400, function() { t(".fluid_dg_loader", h).css({ visibility: "visible" }) })); var w, x, R, F, M, O = i.rows,
                    I = i.cols,
                    H = 1,
                    A = 0,
                ...
                x = void 0 !== G && !1 !== G && "" !== G ? parseFloat(G) : i.time; var j = t(" > div", m).eq(g).attr("data-transPeriod"); switch (R = void 0 !== j && !1 !== j && "" !== j ? parseFloat(j) : i.transPeriod, t(m).hasClass("fluid_dgstarted") || (F = "simpleFade", N = "next", M = "", R = 400, t(m).addClass("fluid_dgstarted")), F) {
                    ...
                    case "curtainSliceRight":
                        I = 0 == i.slicedCols ? i.cols : i.slicedCols, O = 1; break;
                    ...
                    case "blindCurtainSliceBottom":
                        O = 0 == i.slicedRows ? i.rows : i.slicedRows, I = 1; break;
                    case "stampede":
                        A = "-" + R; break;
                    case "mosaic":
                    case "mosaicReverse":
                        A = i.gridDifference; break;
                    case "mosaicRandom":
                        break;
                    case "mosaicSpiral":
                    case "mosaicSpiralReverse":
                        A = i.gridDifference, H = 1.7; break;
                    case "topLeftBottomRight":
                    case "bottomRightTopLeft":
                    case "bottomLeftTopRight":
                    case "topRightBottomLeft":
                        A = i.gridDifference, H = 6; break;
                    case "scrollLeft":
                    case "scrollRight":
                    case "scrollTop":
                    case "scrollBottom":
                        I = 1, O = 1; break;
                    case "scrollHorz":
                        I = 1, O = 1 } for (var Y, Z, at = 0, et = O * I, ot = K - Math.floor(K / I) * I, dt = J - Math.floor(J / O) * O, rt = 0, st = 0, nt = new Array, lt = new Array, ct = new Array; et > at;) { nt.push(at), lt.push(at), P.append('<div class="fluid_dgappended" style="display:none; overflow:hidden; position:absolute; z-index:1000" />'); var ht = t(".fluid_dgappended:eq(" + at + ")", _); "scrollLeft" == F || "scrollRight" == F || "scrollTop" == F || "scrollBottom" == F || "scrollHorz" == F ? U.eq(g).clone().show().appendTo(ht) : "next" == N ? U.eq(g).clone().show().appendTo(ht) : U.eq(o).clone().show().appendTo(ht), Y = ot > at % I ? 1 : 0, at % I == 0 && (rt = 0), Z = Math.floor(at / I) < dt ? 1 : 0, ht.css({ height: Math.floor(J / O + Z + 1), left: rt, top: st, width: Math.floor(K / I + Y + 1) }), t("> .fluid_dgSlide", ht).css({ height: J, "margin-left": "-" + rt + "px", "margin-top": "-" + st + "px", width: K }), rt = rt + ht.width() - 1, at % I == I - 1 && (st = st + ht.height() - 1), at++ } switch (F) {
                    case "curtainTopLeft":
                    case "curtainBottomLeft":
                    case "curtainSliceLeft":
                        break;
                    ...
                    case "mosaicSpiral":
                        var ft = O / 2,
                            ut = 0; for (gt = 0; ft > gt; gt++) { for (pt = gt, mt = gt; I - gt - 1 > mt; mt++) ct[ut++] = pt * I + mt; for (mt = I - gt - 1, pt = gt; O - gt - 1 > pt; pt++) ct[ut++] = pt * I + mt; for (pt = O - gt - 1, mt = I - gt - 1; mt > gt; mt--) ct[ut++] = pt * I + mt; for (mt = gt, pt = O - gt - 1; pt > gt; pt--) ct[ut++] = pt * I + mt }
                        nt = ct; break;
                    case "mosaicSpiralReverse":
                        var gt;
                        ft = O / 2, ut = et - 1; for (gt = 0; ft > gt; gt++) { for (pt = gt, mt = gt; I - gt - 1 > mt; mt++) ct[ut--] = pt * I + mt; for (mt = I - gt - 1, pt = gt; O - gt - 1 > pt; pt++) ct[ut--] = pt * I + mt; for (pt = O - gt - 1, mt = I - gt - 1; mt > gt; mt--) ct[ut--] = pt * I + mt; for (mt = gt, pt = O - gt - 1; pt > gt; pt--) ct[ut--] = pt * I + mt }
                        nt = ct; break;
                    case "topLeftBottomRight":
                        for (var pt = 0; O > pt; pt++)
                            for (var mt = 0; I > mt; mt++) ct.push(mt + pt);
                        lt = ct; break;
                    case "bottomRightTopLeft":
                        for (pt = 0; O > pt; pt++)
                            for (mt = 0; I > mt; mt++) ct.push(mt + pt);
                        lt = ct.reverse(); break;
                    case "bottomLeftTopRight":
                        for (pt = O; pt > 0; pt--)
                            for (mt = 0; I > mt; mt++) ct.push(mt + pt);
        ...
        i = t.extend({}, { alignment: "center", autoAdvance: !0, mobileAutoAdvance: !0, barDirection: "leftToRight", barPosition: "bottom", cols: 6, easing: "easeInOutExpo", mobileEasing: "", fx: "random", mobileFx: "", gridDifference: 250, height: "50%", imagePath: "images/", hover: !0, loader: "pie", loaderColor: "#eeeeee", loaderBgColor: "#222222", loaderOpacity: .8, loaderPadding: 2, loaderStroke: 7, minHeight: "200px", navigation: !0, navigationHover: !0, mobileNavHover: !0, opacityOnGrid: !1, overlayer: !0, pagination: !0, playPause: !0, pauseOnClick: !0, pieDiameter: 38, piePosition: "rightTop", portrait: !1, rows: 4, slicedCols: 12, slicedRows: 8, slideOn: "random", thumbnails: !1, time: 7e3, transPeriod: 1500, onEndTransition: function() {}, onLoaded: function() {}, onStartLoading: function() {}, onStartTransition: function() {} }, i); var h = t(this).addClass("fluid_dg_wrap");
        h.wrapInner('<div class="fluid_dg_src" />').wrapInner('<div class="fluid_dg_fakehover" />'); var f, u = t(".fluid_dg_fakehover", h),
            g = h;
        u.append('<div class="fluid_dg_target"></div>'), 1 == i.overlayer && u.append('<div class="fluid_dg_overlayer"></div>'), u.append('<div class="fluid_dg_target_content"></div>'), "pie" == (f = "pie" != i.loader || t.support.borderRadius ? i.loader : "bar") ? u.append('<div class="fluid_dg_pie"></div>') : "bar" == f ? u.append('<div class="fluid_dg_bar"></div>') : u.append('<div class="fluid_dg_bar" style="display:none"></div>'), 1 == i.playPause && u.append('<div class="fluid_dg_commands"></div>'), 1 == i.navigation && u.append('<div class="fluid_dg_prev"><span></span></div>').append('<div class="fluid_dg_next"><span></span></div>'), 1 == i.thumbnails && h.append('<div class="fluid_dg_thumbs_cont" />'), 1 == i.thumbnails && 1 != i.pagination && t(".fluid_dg_thumbs_cont", h).wrap("<div />").wrap('<div class="fluid_dg_thumbs" />').wrap("<div />").wrap('<div class="fluid_dg_command_wrap" />'), 1 == i.pagination && h.append('<div class="fluid_dg_pag"></div>'), t(".fluid_dg_caption", h).each(function() { t(this).wrapInner("<div />") }); var p = "pie_" + h.index(),
            m = t(".fluid_dg_src", h),
            _ = t(".fluid_dg_target", h),
            v = t(".fluid_dg_target_content", h),
            b = t(".fluid_dg_pie", h),
            y = t(".fluid_dg_bar", h),
            C = t(".fluid_dg_prev", h),
            w = t(".fluid_dg_next", h),
            x = t(".fluid_dg_commands", h),
            k = t(".fluid_dg_pag", h),
            T = t(".fluid_dg_thumbs_cont", h),
            L = new Array;
        t("> div", m).each(function() { L.push(t(this).attr("data-src")) }); var R = new Array;
        t("> div", m).each(function() { t(this).attr("data-link") ? R.push(t(this).attr("data-link")) : R.push("") }); var F = new Array;
        t("> div", m).each(function() { t(this).attr("data-target") ? F.push(t(this).attr("data-target")) : F.push("") }); var S = new Array;
        t("> div", m).each(function() { t(this).attr("data-portrait") ? S.push(t(this).attr("data-portrait")) : S.push("") }); var B = new Array;
        t("> div", m).each(function() { t(this).attr("data-alignment") ? B.push(t(this).attr("data-alignment")) : B.push("") }); var M = new Array;
        t("> div", m).each(function() { t(this).attr("data-thumb") ? M.push(t(this).attr("data-thumb")) : M.push("") }); var O, q = L.length; for (1 >= q && (i.autoAdvance = !1, i.mobileAutoAdvance = !1, i.navigation = !1, i.navigationHover = !0, i.mobileNavHover = !0, i.pagination = !1, i.playPause = !1, i.thumbnails = !1), t(v).append('<div class="fluid_dgContents" />'), O = 0; q > O; O++)
            if (t(".fluid_dgContents", v).append('<div class="fluid_dgContent" />'), "" != R[O]) { var I = t("> div ", m).eq(O).attr("data-box");
                I = void 0 !== I && !1 !== I && "" != I ? 'data-box="' + t("> div ", m).eq(O).attr("data-box") + '"' : "", t(".fluid_dg_target_content .fluid_dgContent:eq(" + O + ")", h).append('<a class="fluid_dg_link" href="' + R[O] + '" ' + I + ' target="' + F[O] + '"></a>') }
        t(".fluid_dg_caption", h).each(function() { var i = t(this).parent().index(),
                a = h.find(".fluid_dgContent").eq(i);
            t(this).appendTo(a) }), _.append('<div class="fluid_dgCont" />'); var H, A, P = t(".fluid_dgCont", h); for (H = 0; q > H; H++) { P.append('<div class="fluid_dgSlide fluid_dgSlide_' + H + '" />'); var W = t("> div:eq(" + H + ")", m);
            _.find(".fluid_dgSlide_" + H).clone(W) }
        t(window).bind("load resize pageshow", function() { n(), o() }), P.append('<div class="fluid_dgSlide fluid_dgSlide_' + H + '" />'), h.show(); var D, E, z, N, G, j, Q, K = _.width(),
            J = _.height(); if (t(window).bind("resize pageshow", function() { 1 == A && d(), t("ul", T).animate({ "margin-top": 0 }, 0, n), m.hasClass("paused") || (m.addClass("paused"), t(".fluid_dg_stop", X).length ? (t(".fluid_dg_stop", X).hide(), t(".fluid_dg_play", X).show(), "none" != f && t("#" + p).hide()) : "none" != f && t("#" + p).hide(), clearTimeout(D), D = setTimeout(function() { m.removeClass("paused"), t(".fluid_dg_play", X).length ? (t(".fluid_dg_play", X).hide(), t(".fluid_dg_stop", X).show(), "none" != f && t("#" + p).fadeIn()) : "none" != f && t("#" + p).fadeIn() }, 1500)) }), 0 == (N = e() && "" != i.mobileAutoAdvance ? i.mobileAutoAdvance : i.autoAdvance) && m.addClass("paused"), G = e() && "" != i.mobileNavHover ? i.mobileNavHover : i.navigationHover, 0 != m.length) { var U = t(".fluid_dgSlide", _);
            U.wrapInner('<div class="fluid_dgrelative" />'); var V = i.barDirection,
                X = h;
            t("iframe", u).each(function() { var i = t(this),
                    a = i.attr("src");
                i.attr("data-src", a); var e = i.parent().index(".fluid_dg_src > div");
                ...
                case "left":
                    y.css({ right: "auto", width: i.loaderStroke }); break;
                case "right":
                    y.css({ left: "auto", width: i.loaderStroke }); break;
                case "top":
                    y.css({ bottom: "auto", height: i.loaderStroke }); break;
                case "bottom":
                    y.css({ top: "auto", height: i.loaderStroke }) } switch (V) {
                case "leftToRight":
                case "rightToLeft":
                    Y.css({ left: 0, right: 0, top: i.loaderPadding, bottom: i.loaderPadding }); break;
                case "topToBottom":
                    Y.css({ left: i.loaderPadding, right: i.loaderPadding, top: 0, bottom: 0 }); break;
                case "bottomToTop":
                    Y.css({ left: i.loaderPadding, right: i.loaderPadding, top: 0, bottom: 0 }) } } else { var Y, Z, $, tt; switch (b.append('<canvas id="' + p + '"></canvas>'), (Y = document.getElementById(p)).setAttribute("width", i.pieDiameter), Y.setAttribute("height", i.pieDiameter), i.piePosition) {
                case "leftTop":
                    Z = "left:0; top:0;"; break;
                case "rightTop":
                    Z = "right:0; top:0;"; break;
                case "leftBottom":
                    Z = "left:0; bottom:0;"; break;
                case "rightBottom":
                    Z = "right:0; bottom:0;" } if (Y.setAttribute("style", "position:absolute; z-index:1002; " + Z), Y && Y.getContext) { var it = Y.getContext("2d");
                it.rotate(1.5 * Math.PI), it.translate(-i.pieDiameter, 0) } } if (("none" == f || 0 == N) && (t("#" + p).hide(), t(".fluid_dg_canvas_wrap", X).hide()), t(k).length) { var at; for (t(k).append('<ul class="fluid_dg_pag_ul" />'), at = 0; q > at; at++) t(".fluid_dg_pag_ul", h).append('<li class="pag_nav_' + at + '" style="position:relative; z-index:1002"><span><span>' + at + "</span></span></li>");
            t(".fluid_dg_pag_ul li", h).hover(function() { if (t(this).addClass("fluid_dg_hover"), t(".fluid_dg_thumb", this).length) { var i = t(".fluid_dg_thumb", this).outerWidth(),
                        a = t(".fluid_dg_thumb", this).outerHeight(),
                        e = t(this).outerWidth();
                    t(".fluid_dg_thumb", this).show().css({ top: "-" + a + "px", left: "-" + (i - e) / 2 + "px" }).animate({ opacity: 1, "margin-top": "-3px" }, 200), t(".thumb_arrow", this).show().animate({ opacity: 1, "margin-top": "-3px" }, 200) } }, function() { t(this).removeClass("fluid_dg_hover"), t(".fluid_dg_thumb", this).animate({ "margin-top": "-20px", opacity: 0 }, 200, function() { t(this).css({ marginTop: "5px" }).hide() }), t(".thumb_arrow", this).animate({ "margin-top": "-20px", opacity: 0 }, 200, function() { t(this).css({ marginTop: "5px" }).hide() }) }) }
        t(T).length ? t(k).length ? (t.each(M, function(i, a) { if ("" != t("> div", m).eq(i).attr("data-thumb")) { var e = t("> div", m).eq(i).attr("data-thumb"),
                    o = new Image;
                o.src = e, t("li.pag_nav_" + i, k).append(t(o).attr("class", "fluid_dg_thumb").css({ position: "absolute" }).animate({ opacity: 0 }, 0)), t("li.pag_nav_" + i + " > img", k).after('<div class="thumb_arrow" />'), t("li.pag_nav_" + i + " > .thumb_arrow", k).animate({ opacity: 0 }, 0) } }), h.css({ marginBottom: t(k).outerHeight() })) : (t(T).append("<div />"), t(T).before('<div class="fluid_dg_prevThumbs hideNav"><div></div></div>').before('<div class="fluid_dg_nextThumbs hideNav"><div></div></div>'), t("> div", T).append("<ul />"), t.each(M, function(i, a) { if ("" != t("> div", m).eq(i).attr("data-thumb")) { var e = t("> div", m).eq(i).attr("data-thumb"),
                    o = new Image;
                o.src = e, t("ul", T).append('<li class="pix_thumb pix_thumb_' + i + '" />'), t("li.pix_thumb_" + i, T).append(t(o).attr("class", "fluid_dg_thumb")) } })) : !t(T).length && t(k).length && h.css({ marginBottom: t(k).outerHeight() }); var et = !0;
        t(x).length && (t(x).append('<div class="fluid_dg_play"></div>').append('<div class="fluid_dg_stop"></div>'), 1 == N ? (t(".fluid_dg_play", X).hide(), t(".fluid_dg_stop", X).show()) : (t(".fluid_dg_stop", X).hide(), t(".fluid_dg_play", X).show())), l(), t(".moveFromLeft, .moveFromRight, .moveFromTop, .moveFromBottom, .fadeIn, .fadeFromLeft, .fadeFromRight, .fadeFromTop, .fadeFromBottom", u).each(function() { t(this).css("visibility", "hidden") }), i.onStartLoading.call(this), c(), t(C).length && t(C).click(function() { if (!m.hasClass("fluid_dgsliding")) { var a = parseFloat(t(".fluid_dgSlide.fluid_dgcurrent", _).index());
                clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", h).animate({ opacity: 0 }, 0), l(), c(0 != a ? a : q), i.onStartLoading.call(this) } }), t(w).length && t(w).click(function() { if (!m.hasClass("fluid_dgsliding")) { var a = parseFloat(t(".fluid_dgSlide.fluid_dgcurrent", _).index());
                clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", X).animate({ opacity: 0 }, 0), l(), c(a == q - 1 ? 1 : a + 2), i.onStartLoading.call(this) } }), e() && (u.bind("swipeleft", function(a) { if (!m.hasClass("fluid_dgsliding")) { var e = parseFloat(t(".fluid_dgSlide.fluid_dgcurrent", _).index());
                clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", X).animate({ opacity: 0 }, 0), l(), c(e == q - 1 ? 1 : e + 2), i.onStartLoading.call(this) } }), u.bind("swiperight", function(a) { if (!m.hasClass("fluid_dgsliding")) { var e = parseFloat(t(".fluid_dgSlide.fluid_dgcurrent", _).index());
                clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", X).animate({ opacity: 0 }, 0), l(), c(0 != e ? e : q), i.onStartLoading.call(this) } })), t(k).length && t(".fluid_dg_pag li", h).click(function() { if (!m.hasClass("fluid_dgsliding")) { var a = parseFloat(t(this).index());
                a != parseFloat(t(".fluid_dgSlide.fluid_dgcurrent", _).index()) && (clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", X).animate({ opacity: 0 }, 0), l(), c(a + 1), i.onStartLoading.call(this)) } }), t(T).length && (t(".pix_thumb img", T).click(function() { if (!m.hasClass("fluid_dgsliding")) { var a = parseFloat(t(this).parents("li").index());
                a != parseFloat(t(".fluid_dgcurrent", _).index()) && (clearInterval(E), r(), t("#" + p + ", .fluid_dg_canvas_wrap", X).animate({ opacity: 0 }, 0), t(".pix_thumb", T).removeClass("fluid_dgcurrent"), t(this).parents("li").addClass("fluid_dgcurrent"), l(), c(a + 1), n(), i.onStartLoading.call(this)) } }), t(".fluid_dg_thumbs_cont .fluid_dg_prevThumbs", X).hover(function() { t(this).stop(!0, !1).animate({ opacity: 1 }, 250) }, function() { t(this).stop(!0, !1).animate({ opacity: .7 }, 250) }), t(".fluid_dg_prevThumbs", X).click(function() { var i = 0,
                a = (t(T).outerWidth(), t("ul", T).offset().left),
                e = t("> div", T).offset().left - a;
            t(".fluid_dg_visThumb", T).each(function() { var a = t(this).outerWidth();
                i += a }), e - i > 0 ? t("ul", T).animate({ "margin-left": "-" + (e - i) + "px" }, 500, o) : t("ul", T).animate({ "margin-left": 0 }, 500, o) }), t(".fluid_dg_thumbs_cont .fluid_dg_nextThumbs", X).hover(function() { t(this).stop(!0, !1).animate({ opacity: 1 }, 250) }, function() { t(this).stop(!0, !1).animate({ opacity: .7 }, 250) }), t(".fluid_dg_nextThumbs", X).click(function() { var i = 0,
                a = t(T).outerWidth(),
                e = t("ul", T).outerWidth(),
                d = t("ul", T).offset().left,
                r = t("> div", T).offset().left - d;
            t(".fluid_dg_visThumb", T).each(function() { var a = t(this).outerWidth();
                i += a }), e > r + i + i ? t("ul", T).animate({ "margin-left": "-" + (r + i) + "px" }, 500, o) : t("ul", T).animate({ "margin-left": "-" + (e - a) + "px" }, 500, o) })) } }(jQuery),
function(t) { t.fn.fluid_dgStop = function() { var i = t(this),
            a = t(".fluid_dg_src", i);
        i.index(), a.addClass("stopped"), t(".fluid_dg_showcommands").length && t(".fluid_dg_thumbs_wrap", i) } }(jQuery),
function(t) { t.fn.fluid_dgPause = function() { var i = t(this);
        t(".fluid_dg_src", i).addClass("paused") } }(jQuery),
function(t) { t.fn.fluid_dgResume = function() { var i = t(this),
            a = t(".fluid_dg_src", i);
        ("undefined" == typeof autoAdv || !0 !== autoAdv) && a.removeClass("paused") } }(jQuery);
...
! function(t) { var e = {},
    ...
    t.fn.bxSlider = function(n) { if (0 == this.length) return this; if (this.length > 1) return this.each(function() { t(this).bxSlider(n) }), this; var o = {},
        ...
        e.el = this; var a = t(window).width(),
            ...
            g = function(e, i) { var s = e.find("img, iframe").length; if (0 != s) { var n = 0;
                    e.find("img, iframe").each(function() { t(this).one("load", function() {++n == s && i() }).each(function() { this.complete && t(this).load() }) }) } else i() },
            ...
            S = function() { if (o.children.length > o.settings.maxSlides && o.active.last && !o.settings.infiniteLoop) { if ("horizontal" == o.settings.mode) { var t = o.children.last(),
                        ...
                        b(-e.top, "reset", 0) } } else { e = o.children.eq(o.active.index * m()).position();
            ...
            q = function(e) { var i = o.children.length; if ("short" == o.settings.pagerType) return o.settings.maxSlides > 1 && (i = Math.ceil(o.children.length / o.settings.maxSlides)), void o.pagerEl.html(e + 1 + o.settings.pagerShortSeparator + i);
                o.pagerEl.find("a").removeClass("active"), o.pagerEl.each(function(i, s) { t(s).find("a").eq(e).addClass("active") }) },
            ...
            H = function() { if (o.settings.autoDelay > 0) setTimeout(r.startAuto, o.settings.autoDelay);
                else r.startAuto();
            ...
            L = function() { var e = 0; if ("next" == o.settings.autoDirection) r.append(o.children.clone().addClass("bx-clone"));
                ...
                b(e, "reset", 0), o.settings.pager = !1, o.settings.controls = !1, o.settings.autoControls = !1, o.settings.tickerHover && !o.usingCSS && o.viewport.hover(function() { r.stop() }, function() { var e = 0;
                    ...
                    F(n) }), F() },
            F = function(t) { speed = t || o.settings.speed; var e = { left: 0, top: 0 },
                ...
                b(s, "ticker", speed, n) },
            N = function() { o.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }, o.viewport.bind("touchstart", O) },
            O = function(t) { if (o.working) t.preventDefault();
            ...
            X = function(t) { var e = t.originalEvent,
                    ...
                    s = Math.abs(e.changedTouches[0].pageY - o.touch.start.y); if (3 * i > s && o.settings.preventDefaultSwipeX ? t.preventDefault() : 3 * s > i && o.settings.preventDefaultSwipeY && t.preventDefault(), "fade" != o.settings.mode && o.settings.oneToOneTouch) { var n = 0; if ("horizontal" == o.settings.mode) { r = e.changedTouches[0].pageX - o.touch.start.x;
            ...
            Y = function(t) { o.viewport.unbind("touchmove", X); var e = t.originalEvent,
                    i = 0; if (o.touch.end.x = e.changedTouches[0].pageX, o.touch.end.y = e.changedTouches[0].pageY, "fade" == o.settings.mode)(s = Math.abs(o.touch.start.x - o.touch.end.x)) >= o.settings.swipeThreshold && (o.touch.start.x > o.touch.end.x ? r.goToNextSlide() : r.goToPrevSlide(), r.stopAuto());
                else { var s = 0; "horizontal" == o.settings.mode ? (s = o.touch.end.x - o.touch.start.x, i = o.touch.originalPos.left) : (s = o.touch.end.y - o.touch.start.y, i = o.touch.originalPos.top), !o.settings.infiniteLoop && (0 == o.active.index && s > 0 || o.active.last && s < 0) ? b(i, "reset", 200) : Math.abs(s) >= o.settings.swipeThreshold ? (s < 0 ? r.goToNextSlide() : r.goToPrevSlide(), r.stopAuto()) : b(i, "reset", 200) }
            ...
            V = function(e) { if (o.initialized) { var i = t(window).width(),
                ...
                if (o.working = !0, o.oldIndex = o.active.index, e < 0 ? o.active.index = x() - 1 : e >= x() ? o.active.index = 0 : o.active.index = e, o.settings.onSlideBefore(o.children.eq(o.active.index), o.oldIndex, o.active.index), "next" == i ? o.settings.onSlideNext(o.children.eq(o.active.index), o.oldIndex, o.active.index) : "prev" == i && o.settings.onSlidePrev(o.children.eq(o.active.index), o.oldIndex, o.active.index), o.active.last = o.active.index >= x() - 1, o.settings.pager && q(o.active.index), o.settings.controls && W(), "fade" == o.settings.mode) o.settings.adaptiveHeight && o.viewport.height() != p() && o.viewport.animate({ height: p() }, o.settings.adaptiveHeightSpeed), o.children.filter(":visible").fadeOut(o.settings.speed).css({ zIndex: 0 }), o.children.eq(o.active.index).css("zIndex", o.settings.slideZIndex + 1).fadeIn(o.settings.speed, function() { t(this).css("zIndex", o.settings.slideZIndex), D() });
                        ...
                        if ("horizontal" == o.settings.mode) n = (d = o.children.eq(o.children.length - 1)).position(), s = o.viewport.width() - d.outerWidth();
                        else { var a = o.children.length - o.settings.minSlides;
                            n = o.children.eq(a).position() }
                    else if (o.carousel && o.active.last && "prev" == i) { var l = 1 == o.settings.moveSlides ? o.settings.maxSlides - m() : (x() - 1) * m() - (o.children.length - o.settings.maxSlides),
                            d = r.children(".bx-clone").eq(l);
                        n = d.position() } else if ("next" == i && 0 == o.active.index) n = r.find("> .bx-clone").eq(o.settings.maxSlides).position(), o.active.last = !1;
                    else if (e >= 0) { var c = e * m();
                        n = o.children.eq(c).position() } if (void 0 !== n) { var g = "horizontal" == o.settings.mode ? -(n.left - s) : -n.top;
...
(function(a) { a.fn.DG_Slider = function(b) {
        function Z(b, c, d, e) { var f = []; var g = d; var h = false; if (e == "backward") { b = a.makeArray(b);
                b.reverse() } while (g > 0) { a.each(b, function(b, d) { if (g > 0) { if (!h) { if (b == c) { h = true;
                                f.push(a(this).clone());
                                g-- } } else { f.push(a(this).clone());
                            g-- } } else { return false } }) } return f }

        function Y() { var a = i.outerHeight() * b.displaySlideQty; return a }

        function X() { var a = i.outerWidth() * b.displaySlideQty; return a }

        function W(b, c) { if (c == "left") { var d = a(".pager", h).eq(b).position().left } else if (c == "top") { var d = a(".pager", h).eq(b).position().top } return d }

        function V() { if (!b.infiniteLoop && b.hideControlOnEnd) { if (x == F) { a(".DG-prev", h).hide() } else { a(".DG-prev", h).show() } if (x == G) { a(".DG-next", h).hide() } else { a(".DG-next", h).show() } } }

        function U(c, e, f, g) { p = a('<a href="" class="DG-start"></a>'); if (c == "text") { r = e } else { r = '<img src="../common/' + e + '" />' } if (f == "text") { s = g } else { s = '<img src="../common/' + g + '" />' } if (b.autoControlsSelector) { a(b.autoControlsSelector).append(p) } else { h.append('<div class="DG-auto"></div>');
                a(".DG-auto", h).html(p) }
            p.click(function() { if (b.ticker) { if (a(this).hasClass("stop")) { d.stopTicker() } else if (a(this).hasClass("start")) { d.startTicker() } } else { if (a(this).hasClass("stop")) { d.stopShow(true) } else if (a(this).hasClass("start")) { d.startShow(true) } } return false }) }

        function T() { var c = a("img", g.eq(x)).attr("title"); if (c != "") { if (b.captionsSelector) { a(b.captionsSelector).html(c) } else { a(".DG-captions", h).html(c) } } else { if (b.captionsSelector) { a(b.captionsSelector).html(" ") } else { a(".DG-captions", h).html(" ") } } }

        function S(c) { var e = g.length; if (b.moveSlideQty > 1) { if (g.length % b.moveSlideQty != 0) { e = Math.ceil(g.length / b.moveSlideQty) } else { e = g.length / b.moveSlideQty } } var f = ""; if (b.buildPager) { for (var i = 0; i < e; i++) { f += b.buildPager(i, g.eq(i * b.moveSlideQty)) } } else if (c == "full") { for (var i = 1; i <= e; i++) { f += '<a href="" class="pager-link pager-' + i + '">' + i + "</a>" } } else if (c == "short") { f = '<span class="DG-pager-current lh15em">' + (b.startingSlide + 1) + "</span> " + b.pagerShortSeparator + ' <span class="DG-pager-total">' + g.length + "</span>" } if (b.pagerSelector) { a(b.pagerSelector).append(f);
                n = a(b.pagerSelector) } else { var j = a('<div class="DG-pager pa" style="color:#fff;background:#000;opacity:0.5;filter:alpha(opacity=50);padding:6px 0; left:0; bottom:10px;z-index:4;"></div>');
                j.append(f); if (b.pagerLocation == "top") { h.prepend(j) } else if (b.pagerLocation == "bottom") { h.append(j) }
                n = a(".DG-pager", h) }
            n.children().click(function() { if (b.pagerType == "full") { var a = n.children().index(this); if (b.moveSlideQty > 1) { a *= b.moveSlideQty }
                    d.goToSlide(a) } return false }) }

        function R(c, e, f, g) { var i = a('<a href="" class="DG-next " style="font-size:20px;float:none;color:#ccc;line-height:10px;z-index:4;"></a>'); var j = a('<a href="" class="DG-prev pa" style="font-size:20px; float:none; color:#ccc; line-height:10px;  left:6px;z-index:4;"></a>'); if (c == "text") { i.html(e) } else { i.html('<img src="../common/' + e + '" />') } if (f == "text") { j.html(g) } else { j.html('<img src="../common/' + g + '" />') } if (b.prevSelector) { a(b.prevSelector).append(j) } else { h.append(j) } if (b.nextSelector) { a(b.nextSelector).append(i) } else { h.append(i) }
            i.click(function() { d.goToNextSlide(); return false });
            j.click(function() { d.goToPreviousSlide(); return false }) }

        function Q(c) { if (b.pagerType == "full" && b.pager) { a("a", n).removeClass(b.pagerActiveClass);
                a("a", n).eq(c).addClass(b.pagerActiveClass) } else if (b.pagerType == "short" && b.pager) { a(".DG-pager-current", n).html(x + 1) } }

        function P() { g.not(":eq(" + x + ")").fadeTo(b.speed, 0).css("zIndex", 2);
            g.eq(x).css("zIndex", 3).fadeTo(b.speed, 1, function() { E = false; if (jQuery.browser.msie) { g.eq(x).get(0).style.removeAttribute("filter") }
                b.onAfterSlide(x, g.length, g.eq(x)) }) }

        function O() { e.hover(function() { if (t) { d.stopTicker(false) } }, function() { if (t) { d.startTicker(false) } }) }

        function N() { h.find(".DG-window").hover(function() { if (t) { d.stopShow(false) } }, function() { if (t) { d.startShow(false) } }) }

        function M() { if (b.startImage != "") { startContent = b.startImage;
                startType = "image" } else { startContent = b.startText;
                startType = "text" } if (b.stopImage != "") { stopContent = b.stopImage;
                stopType = "image" } else { stopContent = b.stopText;
                stopType = "text" }
            U(startType, startContent, stopType, stopContent) }

        function L(a, c, d) { if (b.mode == "horizontal") { if (b.tickerDirection == "next") { e.animate({ left: "-=" + c + "px" }, d, "linear", function() { e.css("left", a);
                        L(a, A, b.tickerSpeed) }) } else if (b.tickerDirection == "prev") { e.animate({ left: "+=" + c + "px" }, d, "linear", function() { e.css("left", a);
                        L(a, A, b.tickerSpeed) }) } } else if (b.mode == "vertical") { if (b.tickerDirection == "next") { e.animate({ top: "-=" + c + "px" }, d, "linear", function() { e.css("top", a);
                        L(a, B, b.tickerSpeed) }) } else if (b.tickerDirection == "prev") { e.animate({ top: "+=" + c + "px" }, d, "linear", function() { e.css("top", a);
                        L(a, B, b.tickerSpeed) }) } } }
        ...
        function K() { if (b.auto) { if (!b.infiniteLoop) { if (b.autoDirection == "next") { o = setInterval(function() { x += b.moveSlideQty; if (x > G) { x = x % g.length }
                            d.goToSlide(x, false) }, b.pause) } else if (b.autoDirection == "prev") { o = setInterval(function() { x -= b.moveSlideQty; if (x < 0) { negativeOffset = x % g.length; if (negativeOffset == 0) { x = 0 } else { x = g.length + negativeOffset } }
                            d.goToSlide(x, false) }, b.pause) } } else { if (b.autoDirection == "next") { o = setInterval(function() { d.goToNextSlide(false) }, b.pause) } else if (b.autoDirection == "prev") { o = setInterval(function() { d.goToPreviousSlide(false) }, b.pause) } } } else if (b.ticker) { b.tickerSpeed *= 10;
                a(".pager", h).each(function(b) { A += a(this).width();
                    B += a(this).height() }); if (b.tickerDirection == "prev" && b.mode == "horizontal") { e.css("left", "-" + (A + y) + "px") } else if (b.tickerDirection == "prev" && b.mode == "vertical") { e.css("top", "-" + (B + z) + "px") } if (b.mode == "horizontal") { C = parseInt(e.css("left"));
                    L(C, A, b.tickerSpeed) } else if (b.mode == "vertical") { D = parseInt(e.css("top"));
                    L(D, B, b.tickerSpeed) } if (b.tickerHover) { O() } } }

        function J() { if (b.nextImage != "") { nextContent = b.nextImage;
                nextType = "image" } else { nextContent = b.nextText;
                nextType = "text" } if (b.prevImage != "") { prevContent = b.prevImage;
                prevType = "image" } else { prevContent = b.prevText;
                prevType = "text" }
            R(nextType, nextContent, prevType, prevContent) }

        function I() { if (b.mode == "horizontal" || b.mode == "vertical") { var c = Z(g, 0, b.moveSlideQty, "backward");
                a.each(c, function(b) { e.prepend(a(this)) }); var d = g.length + b.moveSlideQty - 1; var f = g.length - b.displaySlideQty; var h = d - f; var i = Z(g, 0, h, "forward"); if (b.infiniteLoop) { a.each(i, function(b) { e.append(a(this)) }) } } }

        function H() { I(b.startingSlide); if (b.mode == "horizontal") { e.wrap('<div class="' + b.wrapperClass + '" style="width:' + l + 'px; position:relative;"></div>').wrap('<div class="DG-window" style="position:relative; overflow:hidden; width:' + l + 'px;"></div>').css({ width: "999999px", position: "relative", left: "-" + y + "px" });
                e.children().css({ width: j, "float": "left", listStyle: "none" });
                h = e.parent().parent();
                g.addClass("pager") } else if (b.mode == "vertical") { e.wrap('<div class="' + b.wrapperClass + '" style="width:' + v + 'px; position:relative;"></div>').wrap('<div class="DG-window" style="width:' + v + "px; height:" + m + 'px; position:relative; overflow:hidden;"></div>').css({ height: "999999px", position: "relative", top: "-" + z + "px" });
                e.children().css({ listStyle: "none", height: w });
                h = e.parent().parent();
                g.addClass("pager") } else if (b.mode == "fade") { e.wrap('<div class="' + b.wrapperClass + '" style="width:' + v + 'px; position:relative;"></div>').wrap('<div class="DG-window" style="height:' + w + "px; width:" + v + 'px; position:relative; overflow:hidden;"></div>');
                e.children().css({ listStyle: "none", position: "absolute", top: 0, left: 0, zIndex: 2 });
                h = e.parent().parent();
                g.not(":eq(" + x + ")").fadeTo(0, 0);
                g.eq(x).css("zIndex", 99) } if (b.captions && b.captionsSelector == null) { h.append('<div class="DG-captions"></div>') } } var c = { mode: "horizontal", infiniteLoop: true, hideControlOnEnd: false, controls: true, speed: 500, easing: "swing", pager: false, pagerSelector: null, pagerType: "full", pagerLocation: "bottom", pagerShortSeparator: "/", pagerActiveClass: "pager-active", nextText: "<b>»</b>", nextImage: "", nextSelector: null, prevText: " <b>«</b>", prevImage: "", prevSelector: null, captions: false, captionsSelector: null, auto: false, autoDirection: "next", autoControls: false, autoControlsSelector: null, autoStart: true, autoHover: false, autoDelay: 0, pause: 3e3, startText: "start", startImage: "", stopText: "stop", stopImage: "", ticker: false, tickerSpeed: 5e3, tickerDirection: "next", tickerHover: false, wrapperClass: "DG-wrapper", startingSlide: 0, displaySlideQty: 1, moveSlideQty: 1, randomStart: false, onBeforeSlide: function() {}, onAfterSlide: function() {}, onLastSlide: function() {}, onFirstSlide: function() {}, onNextSlide: function() {}, onPrevSlide: function() {}, buildPager: null }; var b = a.extend(c, b); var d = this; var e = ""; var f = ""; var g = ""; var h = ""; var i = ""; var j = ""; var k = ""; var l = ""; var m = ""; var n = ""; var o = ""; var p = ""; var q = ""; var r = ""; var s = ""; var t = true; var u = false; var v = 0; var w = 0; var x = 0; var y = 0; var z = 0; var A = 0; var B = 0; var C = 0; var D = 0; var E = false; var F = 0; var G = g.length - 1;
        this.goToSlide = function(a, c) { if (!E) { E = true;
                x = a;
                b.onBeforeSlide(x, g.length, g.eq(x)); if (typeof c == "undefined") { var c = true } if (c) { if (b.auto) { d.stopShow(true) } }
                slide = a; if (slide == F) { b.onFirstSlide(x, g.length, g.eq(x)) } if (slide == G) { b.onLastSlide(x, g.length, g.eq(x)) } if (b.mode == "horizontal") { e.animate({ left: "-" + W(slide, "left") + "px" }, b.speed, b.easing, function() { E = false;
                        b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "vertical") { e.animate({ top: "-" + W(slide, "top") + "px" }, b.speed, b.easing, function() { E = false;
                        b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "fade") { P() }
                V(); if (b.moveSlideQty > 1) { a = Math.floor(a / b.moveSlideQty) }
                Q(a);
                T() } };
        this.goToNextSlide = function(a) { if (typeof a == "undefined") { var a = true } if (a) { if (b.auto) { d.stopShow(true) } } if (!b.infiniteLoop) { if (!E) { var c = false;
                    x = x + b.moveSlideQty; if (x <= G) { V();
                        b.onNextSlide(x, g.length, g.eq(x));
                        d.goToSlide(x) } else { x -= b.moveSlideQty } } } else { if (!E) { E = true; var c = false;
                    x = x + b.moveSlideQty; if (x > G) { x = x % g.length;
                        c = true }
                    b.onNextSlide(x, g.length, g.eq(x));
                    b.onBeforeSlide(x, g.length, g.eq(x)); if (b.mode == "horizontal") { var f = b.moveSlideQty * k;
                        e.animate({ left: "-=" + f + "px" }, b.speed, b.easing, function() { E = false; if (c) { e.css("left", "-" + W(x, "left") + "px") }
                            b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "vertical") { var h = b.moveSlideQty * w;
                        e.animate({ top: "-=" + h + "px" }, b.speed, b.easing, function() { E = false; if (c) { e.css("top", "-" + W(x, "top") + "px") }
                            b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "fade") { P() } if (b.moveSlideQty > 1) { Q(Math.ceil(x / b.moveSlideQty)) } else { Q(x) }
                    T() } } };
        this.goToPreviousSlide = function(c) { if (typeof c == "undefined") { var c = true } if (c) { if (b.auto) { d.stopShow(true) } } if (!b.infiniteLoop) { if (!E) { var f = false;
                    x = x - b.moveSlideQty; if (x < 0) { x = 0; if (b.hideControlOnEnd) { a(".DG-prev", h).hide() } }
                    V();
                    b.onPrevSlide(x, g.length, g.eq(x));
                    d.goToSlide(x) } } else { if (!E) { E = true; var f = false;
                    x = x - b.moveSlideQty; if (x < 0) { negativeOffset = x % g.length; if (negativeOffset == 0) { x = 0 } else { x = g.length + negativeOffset }
                        f = true }
                    b.onPrevSlide(x, g.length, g.eq(x));
                    b.onBeforeSlide(x, g.length, g.eq(x)); if (b.mode == "horizontal") { var i = b.moveSlideQty * k;
                        e.animate({ left: "+=" + i + "px" }, b.speed, b.easing, function() { E = false; if (f) { e.css("left", "-" + W(x, "left") + "px") }
                            b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "vertical") { var j = b.moveSlideQty * w;
                        e.animate({ top: "+=" + j + "px" }, b.speed, b.easing, function() { E = false; if (f) { e.css("top", "-" + W(x, "top") + "px") }
                            b.onAfterSlide(x, g.length, g.eq(x)) }) } else if (b.mode == "fade") { P() } if (b.moveSlideQty > 1) { Q(Math.ceil(x / b.moveSlideQty)) } else { Q(x) }
                    T() } } };
        this.goToFirstSlide = function(a) { if (typeof a == "undefined") { var a = true }
            d.goToSlide(F, a) };
        this.goToLastSlide = function() { if (typeof a == "undefined") { var a = true }
            d.goToSlide(G, a) };
        this.getCurrentSlide = function() { return x };
        this.getSlideCount = function() { return g.length };
        this.stopShow = function(a) { clearInterval(o); if (typeof a == "undefined") { var a = true } if (a && b.autoControls) { p.html(r).removeClass("stop").addClass("start");
                t = false } };
        this.startShow = function(a) { if (typeof a == "undefined") { var a = true }
            K(); if (a && b.autoControls) { p.html(s).removeClass("start").addClass("stop");
                t = true } };
        this.stopTicker = function(a) { e.stop(); if (typeof a == "undefined") { var a = true } if (a && b.ticker) { p.html(r).removeClass("stop").addClass("start");
                t = false } };
        this.startTicker = function(a) { if (b.mode == "horizontal") { if (b.tickerDirection == "next") { var c = parseInt(e.css("left")); var d = A + c + g.eq(0).width() } else if (b.tickerDirection == "prev") { var c = -parseInt(e.css("left")); var d = c - g.eq(0).width() } var f = d * b.tickerSpeed / A;
                L(C, d, f) } else if (b.mode == "vertical") { if (b.tickerDirection == "next") { var h = parseInt(e.css("top")); var d = B + h + g.eq(0).height() } else if (b.tickerDirection == "prev") { var h = -parseInt(e.css("top")); var d = h - g.eq(0).height() } var f = d * b.tickerSpeed / B;
                L(D, d, f); if (typeof a == "undefined") { var a = true } if (a && b.ticker) { p.html(s).removeClass("start").addClass("stop");
                    t = true } } };
        this.initShow = function() { e = a(this);
            f = e.clone();
            g = e.children();
            h = "";
            i = e.children(":first");
            ...
            F = 0;
            G = g.length - 1;
            g.each(function(b) { if (a(this).outerHeight() > w) { w = a(this).outerHeight() } if (a(this).outerWidth() > v) { v = a(this).outerWidth() } }); if (b.randomStart) { var c = Math.floor(Math.random() * g.length);
                x = c;
                y = k * (b.moveSlideQty + c);
                z = w * (b.moveSlideQty + c) } else { x = b.startingSlide;
                y = k * (b.moveSlideQty + b.startingSlide);
                z = w * (b.moveSlideQty + b.startingSlide) }
            H(); if (b.pager && !b.ticker) { if (b.pagerType == "full") { S("full") } else if (b.pagerType == "short") { S("short") } } if (b.controls && !b.ticker) { J() } if (b.auto || b.ticker) { if (b.autoControls) { M() } if (b.autoStart) { setTimeout(function() { d.startShow(true) }, b.autoDelay) } else { d.stopShow(true) } if (b.autoHover && !b.ticker) { N() } } if (b.moveSlideQty > 1) { Q(Math.ceil(x / b.moveSlideQty)) } else { Q(x) }
            V(); if (b.captions) { T() }
            b.onAfterSlide(x, g.length, g.eq(x)) };
        this.destroyShow = function() { clearInterval(o);
            a(".DG-next, .DG-prev, .DG-pager, .DG-auto", h).remove();
            e.unwrap().unwrap().removeAttr("style");
            e.children().removeAttr("style").not(".pager").remove();
            g.removeClass("pager") };
        this.reloadShow = function() { d.destroyShow();
            d.initShow() };
        this.each(function() { if (a(this).children().length > 0) { d.initShow() } }); return this };
    jQuery.fx.prototype.cur = function() { if (this.elem[this.prop] != null && (!this.elem.style || this.elem.style[this.prop] == null)) { return this.elem[this.prop] } var a = parseFloat(jQuery.css(this.elem, this.prop)); return a } })(jQuery);
/*################ jquery.DG_Slider.min.js ends ###################*/

/*################ jquery.zoom-min.js starts ###################*/
(function(o) { var t = { url: !1, callback: !1, target: !1, duration: 120, on: "mouseover", onZoomIn: !1, onZoomOut: !1 };
    o.zoom = function(t, n, e) { var i, u, c, m, a, r = o(t).css("position"); return o(t).css({ position: /(absolute|fixed)/.test(r) ? r : "relative", overflow: "hidden" }), e.style.width = e.style.height = "", o(e).addClass("zoomImg").css({ position: "absolute", top: 0, left: 0, opacity: 0, width: e.width, height: e.height, border: "none", maxWidth: "none" }).appendTo(t), { init: function() { i = o(t).outerWidth(), u = o(t).outerHeight(), c = (e.width - i) / o(n).outerWidth(), m = (e.height - u) / o(n).outerHeight(), a = o(n).offset() }, move: function(o) { var t = o.pageX - a.left,
                    n = o.pageY - a.top;
                n = Math.max(Math.min(n, u), 0), t = Math.max(Math.min(t, i), 0), e.style.left = t * -c + "px", e.style.top = n * -m + "px" } } }, o.fn.zoom = function(n) { return this.each(function() { var e = o.extend({}, t, n || {}),
                i = e.target || this,
                u = this,
                ...
                a = "mousemove.zoom",
                r = !1;
            (e.url || (e.url = o(u).find("img").attr("src"), e.url)) && (c.onload = function() {
                function t(t) { l.init(), l.move(t), m.stop().fadeTo(o.support.opacity ? e.duration : 0, 1, o.isFunction(e.onZoomIn) ? e.onZoomIn.call(c) : !1) }

                function n() { m.stop().fadeTo(e.duration, 0, o.isFunction(e.onZoomOut) ? e.onZoomOut.call(c) : !1) } var l = o.zoom(i, u, c); "grab" === e.on ? o(u).on("mousedown.zoom", function(e) { 1 === e.which && (o(document).one("mouseup.zoom", function() { n(), o(document).off(a, l.move) }), t(e), o(document).on(a, l.move), e.preventDefault()) }) : "click" === e.on ? o(u).on("click.zoom", function(e) { return r ? void 0 : (r = !0, t(e), o(document).on(a, l.move), o(document).one("click.zoom", function() { n(), r = !1, o(document).off(a, l.move) }), !1) }) : "toggle" === e.on ? o(u).on("click.zoom", function(o) { r ? n() : t(o), r = !r }) : (l.init(), o(u).on("mouseenter.zoom", t).on("mouseleave.zoom", n).on(a, l.move)), o.isFunction(e.callback) && e.callback.call(c) }, c.src = e.url, o(u).one("zoom.destroy", function() { o(u).off(".zoom"), m.remove() })) }) }, o.fn.zoom.defaults = t })(window.jQuery);
/*################ jquery.zoom-min.js ends ###################*/

/*################ 12569.js starts ###################*/
function fddcw() { var e = jQuery(".dynamic-data-container"); if (e.css("width", "auto"), e && e.length) { e.children().hide(); var i = e.css("width");
        e.children().show(), e.css({ width: i, "overflow-x": "auto" }) } }

function imgDisplay(e, t) { for (document.getElementById("imgZoomThumb").src = e, document.getElementById("imgZoom").href = e, as = document.getElementById("imgCounter").getElementsByTagName("a"), i = 0; i < as.length; i++) i == t ? as[i].className = "on" : as[i].className = "" }! function(e) { e(document).ready(function() {
        function n() { e("#projectMoreLinksDiv").slideUp("slow") } var o = e('[data-plugin~="childrenscroller"]'); for (i = 0, j = o.length; i < j; i++) e(o[i]).childrenscroller(); if (fddcw(), e(".formatView").length) { var s = e(".formatView"),
                r = s.children("a"); if ($classifieds = e("#classifieds"), $bxslider = $classifieds.find(".bxslider"), $li = $bxslider.children("li"), liHeight = 0, !r.length) return;
            $li.length && $li.each(function() { liHeight = Math.max(e(this).height(), liHeight) }), s.children("a").each(function() { e(this).click(function() { e(this).hasClass("on") || (e(this).addClass("on").siblings("a").removeClass("on"), $classifieds.length && ($classifieds.toggleClass("classified3Images classified_detailview"), $classifieds.hasClass("classified_detailview") ? $li.css({ height: "auto" }) : $li.css({ height: liHeight }))) }) }) }
        e("#projectMoreLinksA").mouseover(function() { e("#projectMoreLinksDiv").slideDown("slow", function() {}) }), e("#projectMoreLinksA, #projectMoreLinksDiv").mouseleave(function() { t = setTimeout(n, 1e3) }), e("#projectMoreLinksA, #projectMoreLinksDiv").mouseover(function() { clearTimeout(t) }) }), jQuery(window).load(function(i) { var t = e('[class *= "bxslider"]');
        t.length && t.each(function() { e(this).children("li").css({ height: "auto" }), e(this).children("li").EqualHeight() }) }), jQuery(window).resize(function() { var i = e('[class *= "bxslider"]');
        i.length && i.each(function() { e(this).children("li").css({ height: "auto" }), e(this).children("li").EqualHeight() }), fddcw() }), jQuery(window).load(function(i) { var t = e('[class *= "idv_eqheight"]');
        t.length && t.each(function() { e(this).find("li>div").css({ height: "auto" }), e(this).find("li>div").EqualHeight() }) }), jQuery(window).resize(function() { var i = e('[class *= "idv_eqheight"]');
        i.length && i.each(function() { e(this).children("li>div").css({ height: "auto" }), e(this).children("li>div").EqualHeight() }), fddcw() }), e.fn.childrenscroller = function() { if (this.length) { var i = e(this),
                t = { delay: 1e3, pause: 1e3, speed: 500 },
                n = e.extend({}, t, e(this).data("childrenscroller-settings")),
                o = null,
                s = !1; return height = e(this).height(), tags = e(this).children(), this.each(function() { var e = function() { var e = i.children().eq(0).outerHeight(!0);
                        i.height() - i.scrollTop() >= e && (o = setInterval(t, n.pause)) },
                    t = function() { if (!s) { clearInterval(o); var t = i.children().eq(0).outerHeight(!0);
                            i.animate({ scrollTop: t }, n.speed, function() { i.append(i.children().eq(0)), i.scrollTop(0), setTimeout(e, n.pause) }) } };
                i.on("mouseover", function() { s = !0 }), i.on("mouseout", function() { s = !1 }), setTimeout(e, n.delay) }) } }, e.fn.EqualHeight = function() { var i = e(this),
            t = 0;
        this.each(function() { t = Math.max(t, e(this).height()) }), i.css("height", t) } }(jQuery), jQuery(window).load(function() { jQuery(document).innerHeight(); var e = jQuery("header").height(),
            i = jQuery("#middle").height(),
            t = jQuery("footer").outerHeight(),
            n = jQuery(window).height(),
            o = e + i + t,
            s = n - o;
        o <= n && jQuery("footer").css("margin-top", s) }),
    function(e, i, t) { "use strict";
        e.HoverDir = function(i, t) { this.$el = e(t), this._init(i) }, e.HoverDir.defaults = { speed: 300, easing: "ease", hoverDelay: 0, inverse: !1 }, e.HoverDir.prototype = { _init: function(i) { this.options = e.extend(!0, {}, e.HoverDir.defaults, i), this.transitionProp = "all " + this.options.speed + "ms " + this.options.easing, this._loadEvents() }, _loadEvents: function() { var i = this;
                this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir", function(t) { var n = e(this),
                        o = n.find(".gallery-overlay"),
                        s = i._getDir(n, { x: t.pageX, y: t.pageY }),
                        r = i._getStyle(s); "mouseenter" === t.type ? (o.hide().css(r.from), clearTimeout(i.tmhover), i.tmhover = setTimeout(function() { o.show(0, function() { var t = e(this);
                            i.support && t.css("transition", i.transitionProp), i._applyAnimation(t, r.to, i.options.speed) }) }, i.options.hoverDelay)) : (i.support && o.css("transition", i.transitionProp), clearTimeout(i.tmhover), i._applyAnimation(o, r.from, i.options.speed)) }) }, _getDir: function(e, i) { var t = e.width(),
                    n = e.height(),
                    o = (i.x - e.offset().left - t / 2) * (t > n ? n / t : 1),
                    s = (i.y - e.offset().top - n / 2) * (n > t ? t / n : 1); return Math.round((Math.atan2(s, o) * (180 / Math.PI) + 180) / 90 + 3) % 4 }, _getStyle: function(e) { var i, t, n = { left: "0px", top: "-100%" },
                    o = { left: "0px", top: "100%" },
                    s = { left: "-100%", top: "0px" },
                    r = { left: "100%", top: "0px" },
                    a = { top: "0px" },
                    h = { left: "0px" }; switch (e) {
                    case 0:
                        i = this.options.inverse ? o : n, t = a; break;
                    case 1:
                        i = this.options.inverse ? s : r, t = h; break;
                    case 2:
                        i = this.options.inverse ? n : o, t = a; break;
                    case 3:
                        i = this.options.inverse ? r : s, t = h } return { from: i, to: t } }, _applyAnimation: function(i, t, n) { e.fn.applyStyle = this.support ? e.fn.css : e.fn.animate, i.stop().applyStyle(t, e.extend(!0, [], { duration: n + "ms" })) } }; var n = function(e) { i.console && i.console.error(e) };
        e.fn.hoverdir = function(i) { var t = e.data(this, "hoverdir"); if ("string" == typeof i) { var o = Array.prototype.slice.call(arguments, 1);
                this.each(function() { t ? e.isFunction(t[i]) && "_" !== i.charAt(0) ? t[i].apply(t, o) : n("no such method '" + i + "' for hoverdir instance") : n("cannot call methods on hoverdir prior to initialization; attempted to call method '" + i + "'") }) } else this.each(function() { t ? t._init() : t = e.data(this, "hoverdir", new e.HoverDir(i, this)) }); return t } }(jQuery, window);
/*################ 12569.js ends ###################*/
...
(function(c) {
    ...
    function C(a, b, h, l, f, k, p, u, g, d, j, n, q, v, x, r) { g.slideIsRunning = !0;
        ...
        d.resizeImages && (imgInside = a.find("img:first"), imgInside.is("img") && imgInside.animate({ width: l + "px", height: f + "px" }, 1E3 * d.animationTime, d.easing, function() {})) }

    function B(a, b, c) { return a + b >= c ? 0 : 0 > a + b ? c - 1 : a + b }

    function I(a, b, c, l, f, k, p, u, g) {-1 === c.current_img_no - a ? z(1, b, c, l, f, k, p, u, g) : 1 === c.current_img_no - a ? z(-1, b, c, l, f, k, p, u, g) : (c.fastForwardRunning = !0, b.animationTime = 0.4, b.autoPlay = 0.1, c.img_no_where_to_stop = a, c.current_img_no < a ? a - c.current_img_no < p - a + c.current_img_no ? z(1, b, c, l, f, k, p, u, g) : z(-1, b, c, l, f, k, p, u, g) : c.current_img_no > a && (c.current_img_no - a < p - c.current_img_no + a ? z(-1, b, c, l, f, k, p, u, g) : z(1, b, c, l, f, k, p, u, g))) }

    function J() { var a = -1; "Microsoft Internet Explorer" == navigator.appName && null != /MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent) && (a = parseFloat(RegExp.$1)); return parseInt(a, 10) } var D = !1;
    c.fn.roundAbt = function(a) { a = c.extend({}, c.fn.roundAbt.defaults, a); return this.each(function() { var b = c(this);
            ...
            a.enableTouchScreen && a.responsive && (a.width -= 1); var h = c("<div></div>").addClass("roundAbt").addClass(a.skin),
                l = c('<div class="bannerCtrl"> <div class="leftNav"></div> <div class="rightNav"></div> </div> <div class="contentHolder"></div> <div class="elementTitle"></div>\t<div class="playOver"></div> <canvas class="mycanvas"></canvas>');
            b.wrap(h);
            b.after(l); var f = b.parent(".roundAbt"),
                l = c(".bannerCtrl", f),
                k = c(".contentHolder", f),
                h = c('<div class="bNLeft"></div>'),
                p = c('<div class="bottomNav"></div>'),
                u = c('<div class="bNvRight"></div>');
            b.after(h);
            b.after(p);
            b.after(u);
            a.showAllControllers || l.css("display", "none"); var g = c(".leftNav", f),
                d = c(".rightNav", f);
            g.css("display", "none");
            d.css("display", "none");
            a.showNavArrows && a.showOnInitNavArrows && (g.css("display", "block"), d.css("display", "block")); var j = c(".bottomNav", f),
                n = c(".bNLeft", f),
                q = c(".bNvRight", f),
                v;
            j.css("display", "block");
            n.css("display", "block");
            q.css("display", "block");
            j.css({ bottom: a.bottomNavMarginBottom + "px", top: "auto" });
            n.css({ bottom: a.bottomNavMarginBottom + "px", top: "auto" });
            q.css({ bottom: a.bottomNavMarginBottom + "px", top: "auto" });
            a.showBottomNav || (j.css("display", "none"), n.css("display", "none"), q.css("display", "none"));
            a.showOnInitBottomNav || (j.css("left", "-5000px"), n.css("left", "-5000px"), q.css("left", "-5000px")); var x = c(".elementTitle", f);
            a.showElementTitle || x.css("display", "none");
            a.elementOrigTop = parseInt(x.css("top").substr(0, x.css("top").lastIndexOf("px")), 10);
            x.css("top", parseInt(a.elementOrigTop / (a.origWidth / a.width), 10)); var r = c(".playOver", f),
                h = J(),
                s = 0,
            ...
            c("iframe", f).each(function() { var a = c(this).attr("src"),
                    b = "?wmode=transparent"; - 1 != a.indexOf("?") && (b = "&wmode=transparent");
                c(this).attr("src", a + b) });
            e.current_img_no = 0;
            e.currentImg = c(t[e.current_img_no]);
            f.mouseenter(function() { e.mouseOverBanner = !0;
                clearTimeout(e.timeoutID);
                nowx = (new Date).getTime();
                e.timeElapsed += nowx - e.arcInitialTime;
                a.autoHideNavArrows && a.showNavArrows && (g.css("display", "block"), d.css("display", "block"));
                a.autoHideBottomNav && a.showBottomNav && (j.css({ display: "block", left: parseInt((f.width() - B) / 2, 10) + "px" }), n.css({ display: "block", left: parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) - n.width() + "px" }), q.css({ display: "block", left: parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) + j.width() + parseInt(A.css("padding-left").substring(0, A.css("padding-left").length - 2), 10) + "px" })) });
            f.mouseleave(function() { e.mouseOverBanner = !1;
                nowx = (new Date).getTime();
                a.autoHideNavArrows && a.showNavArrows && (g.css("display", "none"), d.css("display", "none"));
                a.autoHideBottomNav && a.showBottomNav && (j.css("display", "none"), n.css("display", "none"), q.css("display", "none")); if (0 < a.autoPlay && 1 < s && !e.fastForwardRunning && !e.isVideoPlaying) { clearTimeout(e.timeoutID);
                    e.arcInitialTime = (new Date).getTime(); var b = parseInt(1E3 * a.autoPlay - (e.timeElapsed + nowx - e.arcInitialTime), 10);
                    e.timeoutID = setTimeout(function() { z(1, a, e, y, t, f, s, r, x) }, b) } });
            w = c(".cntHoUnit", f);
            w.click(function() { if (!e.slideIsRunning && !e.fastForwardRunning) { var b = c(this).attr("rel");
            ...
            r.click(function() { a.showCircleTimer && c(".mycanvas", f).css({ display: "none" });
                r.css("display", "none");
                C = c("#cntHoUnit_" + e.current_img_no, f).find("img:first");
                C.css("display", "none");
                e.isVideoPlaying = !0 });
            g.mousedown(function() { D = !0;!e.slideIsRunning && !e.fastForwardRunning && (e.isVideoPlaying = !1, clearTimeout(e.timeoutID), z(-1, a, e, y, t, f, s, r, x)) });
            g.mouseup(function() { D = !1 });
            d.mousedown(function() { D = !0;!e.slideIsRunning && !e.fastForwardRunning && (e.isVideoPlaying = !1, clearTimeout(e.timeoutID), z(1, a, e, y, t, f, s, r, x)) });
            d.mouseup(function() { D = !1 }); var y = c(".bNButtonOFF", f);
            y.mousedown(function() { D = !0; if (!e.slideIsRunning && !e.fastForwardRunning) { var b = c(this).attr("rel");
                    b != e.current_img_no && (e.isVideoPlaying = !1, c(y[e.current_img_no]).removeClass("bNButtonON"), I(parseInt(b, 10), a, e, y, t, f, s, r, x)) } });
            y.mouseup(function() { D = !1 });
            y.mouseenter(function() { var b = c(this),
                    e = b.attr("rel");
                a.showPreviewThumbs && (v = c('<div class="bottomOverThumb"></div>'), b.append(v), e = c(t[e]).attr("data-bottom-thumb"), v.html('<img src="' + e + '">'));
                b.addClass("bNButtonON") });
            y.mouseleave(function() { var b = c(this),
                    f = b.attr("rel");
                a.showPreviewThumbs && v.remove();
                e.current_img_no != f && b.removeClass("bNButtonON") });
            a.enableTouchScreen && (h = Math.floor(1E5 * Math.random()), f.wrap('<div id="carouselParent_' + h + '" style="position:relative;" />'), c("#carouselParent_" + h).width(a.width + 1), c("#carouselParent_" + h).height(a.height), f.css({ cursor: "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move", left: "0px", position: "absolute" }), rightVal = parseInt(d.css("right").substring(0, d.css("right").length - 2), 10), f.mousedown(function() { rightVal = parseInt(d.css("right").substring(0, d.css("right").length - 2), 10);
                0 > rightVal && !D && (d.css({ visibility: "hidden", right: "0" }), g.css("visibility", "hidden")) }), f.mouseup(function() { D = !1;
                0 > rightVal && (d.css({ right: rightVal + "px", visibility: "visible" }), g.css("visibility", "visible")) }), f.draggable({ axis: "x", containment: "parent", distance: 10, start: function() { origLeft = c(this).css("left") }, stop: function() { e.effectIsRunning || (finalLeft = c(this).css("left"), direction = 1, origLeft < finalLeft && (direction = -1), z(direction, a, e, y, t, f, s, r, x));
                    0 > rightVal && (d.css({ right: rightVal + "px", visibility: "visible" }), g.css("visibility", "visible"));
                    c(this).css("left", "0px") } })); var G = !1;
            c(window).resize(function() { var d = J();
                ...
                a.responsive && doResizeNow && (!1 !== G && clearTimeout(G), G = setTimeout(function() { var d = a,
                        h = s,
                        p = l,
                        u = A,
                        v = y,
                    ...
                    d.height100Proc && (d.height = responsiveHeight); if (d.origWidth != responsiveWidth || d.width100Proc) d.origWidth > responsiveWidth || d.width100Proc ? d.width = responsiveWidth : d.width100Proc || (d.width = d.origWidth), d.height100Proc || (d.height = d.width / e.bannerRatio), d.width = parseInt(d.width, 10), d.height = parseInt(d.height, 10), d.enableTouchScreen && d.responsive && (d.width -= 1), f.width(d.width), f.height(d.height), k.width(d.width), k.height(d.height), d.enableTouchScreen && (f.parent().width(d.width + 1), f.parent().height(d.height)), p.css("margin-top", parseInt((d.height - g.height()) / 2, 10) + d.nextPrevMarginTop / (d.origWidth / d.width) + "px"), j.css("left", parseInt((f.width() - j.width()) / 2, 10) + "px"), n.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) - n.width() + "px"), q.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) + j.width() + parseInt(u.css("padding-left").substring(0, u.css("padding-left").length - 2), 10) + "px"), r.css({ left: parseInt((d.width - r.width()) / 2, 10) + "px", top: parseInt(d.height - d.cntHoUnitOrigHeight / (d.origWidth / d.width), 10) + parseInt((d.cntHoUnitOrigHeight / (d.origWidth / d.width) - r.height()) / 2, 10) - parseInt(d.verticalAdjustment / (d.origWidth / d.width), 10) + "px", "margin-top": d.playMovieMarginTop / (d.origWidth / d.width) }), x.css("top", parseInt(d.elementOrigTop / (d.origWidth / d.width), 10)), clearTimeout(e.timeoutID), clearInterval(e.intervalID), e.timeoutID = setTimeout(function() { z(1, d, e, v, t, f, h, r, x) }, 0.1);
                    c("body").css("overflow", w) }, 300)) });
            c(y[e.current_img_no]).addClass("bNButtonON");
            h = f.find("img:first");
            h[0].complete ? (c(".myloader", f).css("display", "none"), 0 < a.autoPlay && 1 < s && (a.showCircleTimer && (e.arcInitialTime = (new Date).getTime(), e.timeElapsed = 0, e.intervalID = setInterval(function() { F(e, a) }, 125)), e.timeoutID = setTimeout(function() { z(1, a, e, y, t, f, s, r, x) }, 1E3 * a.autoPlay))) : h.load(function() { c(".myloader", f).css("display", "none");
                0 < a.autoPlay && 1 < s && (a.showCircleTimer && (e.arcInitialTime = (new Date).getTime(), e.timeElapsed = 0, e.intervalID = setInterval(function() { F(e, a) }, 125)), e.timeoutID = setTimeout(function() { z(1, a, e, y, t, f, s, r, x) }, 1E3 * a.autoPlay)) }) }) };
    c.fn.roundAbt.defaults = { skin: "attractive", width: 960, height: 384, width100Proc: !1, height100Proc: !1, autoPlay: 4, numberOfVisibleItems: 7, elementsHorizontalSpacing: 120, elementsVerticalSpacing: 20, verticalAdjustment: 0, animationTime: 0.8, easing: "easeOutQuad", resizeImages: !0, target: "_blank", showElementTitle: !0, showAllControllers: !0, showNavArrows: !0, showOnInitNavArrows: !0, autoHideNavArrows: !0, showBottomNav: !0, showOnInitBottomNav: !0, autoHideBottomNav: !0, showPreviewThumbs: !0, nextPrevMarginTop: 0, playMovieMarginTop: 0, enableTouchScreen: !0, absUrl: "", showCircleTimer: !0, showCircleTimerIE8IE7: !1, circleRadius: 10, circleLineWidth: 4, circleColor: "#FF0000", circleAlpha: 100, behindCircleColor: "#000000", behindCircleAlpha: 50, circleLeftPositionCorrection: 3, circleTopPositionCorrection: 3, responsive: !1, responsiveRelativeToBrowser: !0, bottomNavMarginBottom: 0, origWidth: 0, origHeight: 0, cntHoUnitOrigWidth: 0, cntHoUnitOrigHeight: 0, elementOrigTop: 0, origthumbsHolder_MarginTop: 0, windowOrientationScreenSize0: 0, windowOrientationScreenSize90: 0, windowOrientationScreenSize_90: 0, windowCurOrientation: 0 } })(jQuery);
/*################ allinone.js ends ###################*/