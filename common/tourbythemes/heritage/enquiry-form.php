                ...
                <div class="row1 dt columns12">
                    ...
                    <div class="col-2 wideColumn ip ls">
                        ...
                        <p class="breadcrumb ar2 uu small">
                            <a href="../../../index.php" title="Home">Home</a> <b class="ffv p2px">&rsaquo;</b> Wildlife Tour
                        </p>
                        <form name="static_form" method="POST" action=""  enctype="multipart/form-data" class="inputs-p7px inputs-br5px inputs-bs10px">
                                ...
                                <table class="w100 formTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="data p7px">
											<input type="text" name="dynFrm_your_name" class="input w45 gbiwb p5px" value="" required/></td>
                                    </tr>
                                    <tr>
                                        <td class="w33 headVr ar b p7px"><b class="star">*</b> Your E-mail</td>
                                        <td class="data p7px"><input type="email" name="dynFrm_your_e_mail" class="input w45 gbiwb p5px" value="" required ></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data p7px">
											<input type="Submit" name="submit" class="button dib p10px15px b" value="Send Enquiry" />
										</td>
                                    </tr>
                                </table>
                            </form>
