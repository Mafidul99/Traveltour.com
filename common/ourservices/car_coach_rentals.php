...
$want_to_book = $_POST['dynFrm_want_to_book'];

$one_way = $_POST['dynFrm_tour_type'];
$round_trip = $_POST['dynFrm_tour_type'];
...
$vehicles = $_POST['dynFrm_no_of_vehicles'];

$adults = $_POST['dynFrm_car_no_adults'];
$children = $_POST['dynFrm_car_no_children'];
...
try{
	...
	$mail->Body = "<h3> 
						Want to Book  : $want_to_book <br> 
						Tour Type : $one_way, $round_trip <br> 
						...
						No. of Vehicles  : $vehicles <br>
						No. of Persons : $$adults, $children<br>
