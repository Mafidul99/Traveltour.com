...
if (!empty($_POST)) {
   ...
   if (!empty($errors)) {
       ...
       $mail->addAddress('softdeve84@gmail.com', 'Enquiry Form');
       ...
       $msg='<script>alert("Thank you for Enquiry From, our team will contact with you very soon")</script>';

       if($mail->send()){
            //header("location:thanks.php"); // Redirect to 'thank you' page. Make sure you have it
            echo $msg;
       } else {
