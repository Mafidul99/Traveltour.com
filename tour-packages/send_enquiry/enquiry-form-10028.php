...
<form name="static_form" method="post" action="send_enquiry/send-enquiry.php" form-id="10028" enctype="multipart/form-data" class="inputs-p7px inputs-br5px">
			...
			<div class="fo mt10px">
				...
				<div class="fl w100 mb15px df-dt">
					<div class="df-dtc w50 pr5px dateOpt">
						...
						<div class="pr">
							<input type="date" name="dynFrm_arrival_date" id="dynFrm_arrival_date_10028" placeholder="Departure Date" style="padding-left:32px;" class="dynFrm_arrival_date" required />
							<span class="fl red small"></span>
						</div>
					</div>
