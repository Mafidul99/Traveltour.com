<?php include('send-enquiry10002.php'); ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="del_inHdr ">
    <div class="bodycontent ttw submit-body-space">
        <!---------------------------------------------------------------------------------------------->
        <?php include('pages/enquiry_footer10002.php'); ?>
        <!---------------------------------------------------------------------------------------------->
        <div id="middle">
                ...
                <div class="row1 dt columns12">
                    ...
                    <div class="col-2 wideColumn ip ls">
                        ...
                        <p class="breadcrumb ar2 uu small">
                            ...
                            <b class="ffv p2px">›</b> Enquiry
                        </p>
                        Please submit your inquiry to us by using the form below. We will get back to you as soon as possible. All applications are dealt with in confidence:-<br><br>

                        <form name="static_form" method="POST" action="" enctype="multipart/form-data" class="inputs-p7px inputs-br5px">
                            
                            <a name="enquiry"></a>
                            <table width="100%" cellpadding="4" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td colspan="2">Following are the Services you selected to send your Enquiry:<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="50%">
                                            <input type="checkbox" checked="" name="chk_53300" value="Tour Packages"> &nbsp; Tour Packages</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="w100 formTable">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data p7px">
                                            <input type="date" name="dynFrm_arrival_date" class="input w45 mr10px dynFrm_arrival_date hasDatepicker" value="" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="headVr ar b p7px"><b class="star">*</b> Departure On</td>
                                        <td class="data p7px">
                                            <input type="date" name="dynFrm_departure_date" class="input w45 mr10px dynFrm_departure_date hasDatepicker" value="" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <span class="small">[upto 2000 characters ]</span></td>
                                        <td class="data p7px">
                            ...
                            <table class="w100 formTable">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data p7px">
                                            <input type="email" name="dynFrm_your_e_mail" class="input w45 gbiwb p5px" value="" required></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data p7px">
                                            <input type="text" name="dynFrm_other_city" id="dynFrm_other_city" class="input w45" value="" required></td>
                                    </tr>
                                    <tr>
                                        <td class="w33 headVr ar b p7px"><b class="star">*</b> Contact/Mobile No.</td>
                                        <td class="data p7px">                                            
                                            <input type="number" name="dynFrm_phone_mobile" class="input w45" value="" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="w33 headVr ar b p7px"></td>
                                        <td class="data p7px">
                                            <input type="submit" name="submit" class="button dib p10px15px b" value="Send Enquiry"></td>
                                    </tr>
                                </tbody>
                            </table>
